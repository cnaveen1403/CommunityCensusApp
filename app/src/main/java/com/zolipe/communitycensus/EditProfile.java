...
//        Log.d(LOG_TAG, "mImageType >>> " + mImageType);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (status.equals("success") && status_code.equals("1003")) {
                    ...
                    int position = getPosition(mStateList, AppData.getString(mContext, CensusConstants.state_id));
    ...
    private class UpdateProfile extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            if (userRole.equals("admin")) {
                ...
                //TODO wher will get supervisor id
    ...
    private void saveAppData() {
        ...
        Log.e(TAG, "saveAppData: getDateOfBirth() >>> " + getDateOfBirth() );
